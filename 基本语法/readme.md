...
* [5.四个智能指针](#四个智能指针)
* [6.指针和数组的区别](#指针和数组的区别)
* [7.析构函数必须是虚函数](#析构函数必须是虚函数)
* [8.析构函数的作用](#析构函数的作用)
* [9.new/delete 与 malloc/free ](#内存分配函数 )
* [10.拷贝赋值函数的形参能否进行值传递](拷贝赋值函数的形参能否进行值传递)
* [11.fork,wait,exec 函数](#fork相关)
* [12.stl基本组成](#stl基本组成)
* [13.右值引用和左值引用](#右值引用和左值引用)
* [14.双引号和尖括号区别](#双引号和尖括号区别)
* [15.malloc 的原理  brk 系统调用  mmap 系统调用](#malloc的原理)
<!-- GFM-TOC -->
